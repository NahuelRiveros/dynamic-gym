...
import { BarChart2, TrendingDown, PackageSearch } from "lucide-react";
import {
...
export default function StockEstadisticasPage() {
        ...
        <div className="overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-sm shadow-blue-500/10">
          ...
          <div className="flex flex-col gap-4 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h1 className="mt-2 text-2xl font-extrabold text-slate-900">Recaudación por mercadería</h1>
              <p className="mt-0.5 text-sm text-slate-500">
                Ventas de productos (agua, bebidas, suplementos), aparte de la recaudación por planes.
              </p>
            </div>
